...
$table_name = 'client_concern';
$file_name = 'ticket_concern.php';
...
<head>
  ...
  <title>Ticket Concern - Customer Support</title>
  <style>
    body { 
...
<header>
  <h1>Ticket Concern Management</h1>
</header>

<div class="container">
  <div class="breadcrumb">
    <a href="index.php">Dashboard</a> &gt; Ticket Concern
  </div>

  <div class="content-area">
    <h2>Manage Ticket Concerns</h2>
    <p>Review and resolve customer support tickets related to general ticketing issues.</p>
